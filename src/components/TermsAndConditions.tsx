  ...
  return (
    <section className="pb-24 px-4 sm:px-8 md:px-24">
      ...
      <div>
        ...
        <p>Welcome to TrustGroupCU!</p>
        <p>
          These terms and conditions outline the rules and regulations for the
          use of TrustGroupCU&#39;s Website
        </p>
        <p>
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use TrustGroupCU if you do not agree to
        ...
        <h6>Cookies</h6>
        <p>
          Unless otherwise stated, TrustGroupCU and/or its licensors own the
          ...
          this from TrustGroupCU for your own personal use subjected to
          restrictions set in these terms and conditions.
        </p>
        <p>You must not:</p>
        <ul className="list-inside list-disc">
          <li>Republish material from TrustGroupCU</li>
          <li>Sell, rent or sub-license material from TrustGroupCU</li>
          <li>Reproduce, duplicate or copy material from TrustGroupCU</li>
          <li>Redistribute content from TrustGroupCU</li>
        </ul>
        <p>
        ...
        <p>
          ...
          TrustGroupCU does not filter, edit, publish or review Comments prior
          to their presence on the website. Comments do not reflect the views
          and opinions of TrustGroupCU,its agents and/or affiliates. Comments
          reflect the views and opinions of the person who post their views and
          opinions. To the extent permitted by applicable laws, TrustGroupCU
          shall not be liable for the Comments or for any liability, damages or
          expenses caused and/or suffered as a result of any use of and/or
          posting of and/or appearance of the Comments on this website.
        </p>
        <p>
          TrustGroupCU reserves the right to monitor all Comments and to remove
        ...
        <p>
          You hereby grant TrustGroupCU a non-exclusive license to use,
        ...
        <p>
          ...
          the hyperlink compensates the absence of TrustGroupCU; and (d) the
        ...
        <p>
          ...
          sending an e-mail to TrustGroupCU. Please include your name, your
        ...
        <p>
          No use of TrustGroupCU&#39;s logo or other artwork will be allowed for
